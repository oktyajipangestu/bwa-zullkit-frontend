<script setup>
import FormRegisterComponent from '../components/authentication/FormRegisterComponent.vue';
import FeaturesComponent from '../components/authentication/FeaturesComponent.vue';
</script>
